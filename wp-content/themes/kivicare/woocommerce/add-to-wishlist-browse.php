...
<div class="yith-wcwl-wishlistexistsbrowse">
	<span class="feedback">
		<a href="<?php echo esc_url($wishlist_url); ?>" rel="nofollow" data-title="<?php echo esc_attr($browse_wishlist_text); ?>"> <?php
			...
			<span class="kivicare-wihslist-btn">
			    <?php echo wp_kses( $label,'post' ); ?>
		    </span>
		</a>
	</span>
</div>