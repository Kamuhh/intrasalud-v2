...
/**
 * Kivicare\Utility\Accessibility\Component class
 *
 * @package kivicare
 */

namespace Kivicare\Utility\Accessibility;
...
class Component implements Component_Interface
{
	...
	public function action_enqueue_navigation_script()
	{
		...
		wp_localize_script(
			...
			array(
				'expand'   => esc_html__('Expand child menu', 'kivicare'),
				'collapse' => esc_html__('Collapse child menu', 'kivicare'),
			)
		);
	}
