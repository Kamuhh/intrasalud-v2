...
final class WOOF {
    ...
    public function print_plugin_options() {
        ...
        var woof_ext_url = "<?php echo esc_url(admin_url('admin-ajax.php')) . '?action=woof_upload_ext&extnonce=' . esc_html(wp_create_nonce('add-ext-nonce')) ?>";
